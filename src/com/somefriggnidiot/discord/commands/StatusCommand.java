...
public class StatusCommand extends Command {
   ...
   protected void execute(final CommandEvent event) {
      ...
      String groupingGamesStatus = gi.isGroupingGames() ? "Active" : "_Disabled_";
      String rolesOnLevelsStatus = gi.getRoleLevelMappings().size() > 0 ? "Active" : "_Disabled_";

      EmbedBuilder eb = new EmbedBuilder();
      eb.setTitle(format("%s Information", event.getGuild().getName()));
      eb.setColor(ThreadLocalRandom.current().nextInt(0, 16777216));
